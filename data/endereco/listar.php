...
Isso fará com que todos as funções que estão dentro da classe endereco sejam
    ...
    while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        */
        $array_item = array(
            ...
            "bairro"=>utf8_encode($bairro), #Utilizamos o utf8 para endereços do assento.
            "cep"=>$cep 
        );
        /*
        ...
        array. Assim estamos adicionando ao endereco_arr[saido] um item
