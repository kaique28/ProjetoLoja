...
Isso fará com que todos as funções que estão dentro da classe Usuario sejam
...
consulta no formato sql que seleciona todos os usuário("Select * from usuario")
...
contruido um array com os dados dos usuarios.
...
criado uma array com o nome de saida e assim guardar todos usuarios.
*/
    ...
    */
    while($linha = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        */
        ...
        array. Assim estamos adicionando ao usuario_arr[saido] um item
    ...
    */
    ...
    dos usuario e convertemos para o formato json para exibir ao
    ...
    */
    ...
    caso não haja usuários cadastrados no banco. Junto ao status code será exibida
